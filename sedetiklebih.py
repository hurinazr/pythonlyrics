...
LYRICS = [
    ("Ternyata", 2),
    ("kuperlukan cinta dari dirimu, sayang", 8),
    ("Barulah terasa ku bernyawa", 13),
    ("Kasihku", 5),
    ("ku amat mencintai kamu", 7),
    ("Kerna kau beri erti hidup", 8),
    ("Ku kan terus mencinta...", 5), 
    ("sedetik lebih", 7),
    ("selepas selamanya", 6)
]
...
def main():
    ...
    try:
        ...
        clear()
        closing_lines = ["ku kan terus mencinta <3"]
